...
public class PC_Viking_BotController : BaseBotController
{
    private string actionTwoCancelName;
    private string actionTwoSetName;
    ...
    public override void Setup(bool isPlayerTeam, TurnHandler instance, int index)
    {
        ...
        actionTwoDamage = 50;
        actionTwoCost = 20;
        actionThreeDamage = 60;
        actionThreeCost = 40;

        actionOneName = "Battle Axe";
        actionTwoName = "War Horn";
        actionTwoSetName = actionTwoName;
        actionTwoCancelName = "Stop Taunting";
        actionThreeName = "Pillage";
    ...
    public override IEnumerator ActionTwoMain()
    {
        ...
        if (IsTaunting())
        {
            ...
            ClearTaunting();
            actionTwoName = actionTwoSetName;
        }
        else
        {
            handler.PlaySFX(actionTwoSFX);
            ApplyHealing(actionTwoDamage);
            SetTaunting();
            actionTwoName = actionTwoCancelName;
        }
