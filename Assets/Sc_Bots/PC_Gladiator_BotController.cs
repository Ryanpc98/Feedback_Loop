...
public class PC_Gladiator_BotController : BaseBotController
{
    int prevEnergyGainRate;
    int actionThreeDrain;
    ...
    public override void Setup(bool isPlayerTeam, TurnHandler instance, int index)
    {
        ...
        actionOneName = "Cleave";
        actionTwoName = "Rage";
        actionThreeName = "Grapple";
        ...
        actionTwoSFX = EnumTypes.SFX.schwoop;
        actionThreeSFX = EnumTypes.SFX.punch_3;
    ...
    public override IEnumerator ActionTwoMain()
    {
        ...
        ChangeEnergyGainRate((int)actionTwoDamage);
        ChangeActionCost(2, (int)(2 * actionTwoDamage));
    ...
    public override IEnumerator ActionThreeMain()
    {
        ...
        curTarget.ChangeEnergyGainRate(-1);
